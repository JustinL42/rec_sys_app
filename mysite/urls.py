...
urlpatterns = [
    ...
    re_path(r'^username_change/$',
        views.UserNameChangeView.as_view(), name='username_change'),
    re_path(r'^displayname_change/$', views.DisplayNameChangeView.as_view(),
        name='displayname_change'),
    re_path(r'^email_change/$', views.EmailChangeView.as_view(),
        name='email_change'),
    re_path(r'^account_delete/$',
